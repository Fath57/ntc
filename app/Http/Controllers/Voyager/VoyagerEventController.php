...
class VoyagerEventController extends BaseVoyagerUserController
{
    ...
    public function index(Request $request)
    {
        ...
        $dataTypeContent = (Auth::user()->role->name=="ntc_admin" || Auth::user()->role->name=="admin") ?$dataTypeContent:$dataTypeContent->where('cj_id',Auth::user()->cj->id);
    ...
    public function store(Request $request)
    {
        ...
        if (Auth::user()->role->name=="cj"){
            $data->cj_id = Auth::user()->cj->id;
            $data->save();
        }
