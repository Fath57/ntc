...
class VoyagerCjController extends BaseVoyagerUserController
{
    ...
    public function index(Request $request)
    {
        ...
        $dataTypeContent = (Auth::user()->role->name=="ntc_admin" || Auth::user()->role->name=="admin") ?$dataTypeContent:$dataTypeContent->where('user_id',Auth::id());
