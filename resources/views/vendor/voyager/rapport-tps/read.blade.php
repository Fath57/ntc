                ...
                <div class="panel panel-bordered" style="padding-bottom:5px;">
                    ...
                    @foreach($dataType->readRows as $row)
                        ...
                        <div class="panel-heading" style="border-bottom:0;">
                            @switch($row->field)
                                @case('summary')
                                <h3 class="panel-title">Description de la séance de restitution.</h3>
                                @break
                                  @case('image_saisines')
                                <h3 class="panel-title">Images de  saisine et de l’accusé de réception (en format .pdf)</h3>
                                @break
                                @case('etapes')
                                <h3 class="panel-title">Décrivez les étapes que vous avez mises en place pour saisir la cour</h3>
                                @break
                                @default
                    ...
                    @switch($row->field)
                        @case('user_id')
                            <div class="panel-body" style="padding-top:0;">
                                @php $user = $dataTypeContent->user; @endphp
